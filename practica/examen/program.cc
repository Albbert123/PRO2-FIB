...
int main() {
    ...
    while (comando != "fin") {
        ...
        if(comando == "nuevo_jugador" or comando == "nj") {
            ...
            cout << t << endl;
            if (not ct.existe_torneo(t)) cout << "error: el torneo no existe" << endl;
            else if (not ct.consultar_disputado(t)) cout << "error: torneo no disputado" << endl;
            else if (not ct.consultar_finalizado(t)) cout << "error: torneo en juego" << endl;
            else {
                ct.resultados_torneo(t);
            }
        }
