...
private:
    ...
    */
    BinTree<int> crear_emparejamiento(int profundidad, int raiz, int nivel); 
...
public:
    ...
    */
    ...
    bool consultar_finalizado() const;

    bool consultar_disputado() const;
