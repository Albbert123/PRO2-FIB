...
void Jugador::modificar_perc(const float& porcentaje) {
    perc_sets_g = porcentaje;
}

//Consultoras

float Jugador::consultar_perc() const {
    return perc_sets_g;
}
...
int Jugador::consultar_sets_g() const {
    return sets_g;
}

int Jugador::consultar_sets_p() const {
    return sets_p;
}
